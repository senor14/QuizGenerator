 ...
 * Generated at: 2020-12-07 05:13:48 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.view.cquiz;
...
public final class exam_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("poly.dto.CusQDTO");
  }
 ...
 request.setCharacterEncoding("euc-kr"); 
      ...
      out.write("      }\r\n");
      out.write("      \r\n");
      out.write("      function scoring0(num) {\r\n");
      out.write("    \t  if('");
      out.print(rList.get(0).get(0).getCq_ans());
      out.write("' === $('#answer_0'+num).val()) {\r\n");
      out.write("    \t\t    $('#crop__img__0'+num).css(\"display\", \"block\");\r\n");
      out.write("    \t\t    $('#smile'+num).css(\"display\", \"block\");\r\n");
      out.write("        \t\t$('#nosmile'+num).css(\"display\", \"none\");\r\n");
      out.write("        \t} else {\r\n");
      out.write("        \t\t$('#crop__img__0'+num).css(\"display\", \"block\");\r\n");
      out.write("        \t\t$('#nosmile'+num).css(\"display\", \"block\");\r\n");
      out.write("        \t\t$('#smile'+num).css(\"display\", \"none\");\r\n");
      out.write("        \t}\r\n");
      out.write("    \t  $.ajax({\r\n");
      out.write("              url: '/scoring.do',\r\n");
      out.write("              async : true,\r\n");
      out.write("              type : \"post\",\r\n");
      ...
      out.print(rList.get(0).get(0).getCq_ans());
      out.write(" === $('#answer_0'+num).val()) {\r\n");
      out.write("              \t\t$('.qna__ans__group__num__0'+num).attr(\"src\", \"/img/correct.png\");\r\n");
      out.write("              \t} else {\r\n");
      out.write("              \t\t$('.qna__ans__group__num__0'+num).attr(\"src\", \"/img/incorrect.png\");\r\n");
      out.write("              \t}\r\n");
      out.write("              \t\r\n");
      out.write("              }\r\n");
      out.write("            }) \r\n");
      out.write("      }\r\n");
      out.write("      function scoring1(num) {\r\n");
      out.write("    \t  if('");
      out.print(rList.get(0).get(1).getCq_ans());
      out.write("' === $('#answer_0'+num).val()) {\r\n");
      out.write("    \t\t    $('#crop__img__0'+num).css(\"display\", \"block\");;\r\n");
      out.write("    \t\t    $('#smile'+num).css(\"display\", \"block\");\r\n");
      out.write("        \t\t$('#nosmile'+num).css(\"display\", \"none\");\r\n");
      ...
      out.write("            }) \r\n");
      out.write("      }\r\n");
      out.write("      function scoring2(num) {\r\n");
      out.write("    \t  if('");
      out.print(rList.get(0).get(2).getCq_ans());
      out.write("' === $('#answer_0'+num).val()) {\r\n");
      out.write("    \t\t    $('#crop__img__0'+num).css(\"display\", \"block\");\r\n");
      out.write("    \t\t    $('#smile'+num).css(\"display\", \"block\");\r\n");
      out.write("        \t\t$('#nosmile'+num).css(\"display\", \"none\");\r\n");
      out.write("        \t} else {\r\n");
      out.write("        \t\t$('#crop__img__0'+num).append(\"<img src='/img/nosmile.png'>\");\r\n");
      out.write("        \t\t$('#nosmile'+num).css(\"display\", \"block\");\r\n");
      out.write("        \t\t$('#smile'+num).css(\"display\", \"none\");\r\n");
      out.write("        \t}\r\n");
      out.write("    \t  $.ajax({\r\n");
      ...
      out.write("            }) \r\n");
      out.write("      }\r\n");
      out.write("      function scoring3(num) {\r\n");
      out.write("    \t  if('");
      out.print(rList.get(0).get(3).getCq_ans());
      out.write("' === $('#answer_0'+num).val()) {\r\n");
      out.write("    \t\t  $('#crop__img__0'+num).css(\"display\", \"block\");\r\n");
      out.write("    \t\t  $('#smile'+num).css(\"display\", \"block\");\r\n");
      out.write("      \t\t$('#nosmile'+num).css(\"display\", \"none\");\r\n");
      ...
      out.write("            }) \r\n");
      out.write("      }\r\n");
      out.write("      function scoring4(num) {\r\n");
      out.write("    \t  if('");
      out.print(rList.get(0).get(4).getCq_ans());
      out.write("' === $('#answer_0'+num).val()) {\r\n");
      out.write("        \t\t$('#crop__img__0'+num).css(\"display\", \"block\");\r\n");
      out.write("        \t\t$('#smile'+num).css(\"display\", \"block\");\r\n");
      out.write("        \t\t$('#nosmile'+num).css(\"display\", \"none\");\r\n");
      ...
      out.write("\t\t\t\t\t\t<img id=\"editImg\" src=\"");
      out.print(rList.get(0).get(0).getQ_pic());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" id=\"editImgSrc\" name=\"editImgSrc\" />\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<p>- 색깔 영역을 더블 클릭하면 채점합니다.</p>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"qna__ans__group__num qna__ans__group__num__01\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img class=\"colorShade\" src=\"/img/01.png\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tondblClick=\"scoring0('1');\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src='/img/smile.png' id=\"smile1\" style='display:none'/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src='/img/nosmile.png' id=\"nosmile1\" style='display:none'/>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"qna__ans__group__qna\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"qna__ans__group__pic qna__ans__group__pic__01\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img id=\"crop__img__01\" src=\"");
      out.print(rList.get(0).get(0).getCq_pic());
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"qna__ans__group__num qna__ans__group__num__02\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<img class=\"colorShade\" src=\"/img/02.png\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tondblClick=\"scoring1('2');\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src='/img/smile.png' id=\"smile2\" style='display:none'/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src='/img/nosmile.png' id=\"nosmile2\" style='display:none'/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"qna__ans__group__qna\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"qna__ans__group__pic qna__ans__group__pic__02\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img id=\"crop__img__02\" src=\"");
      out.print(rList.get(0).get(1).getCq_pic());
      out.write("\" style=\"display:none\"> <input type=\"hidden\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"qna__ans__group__num qna__ans__group__num__03\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<img class=\"colorShade\" src=\"/img/03.png\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tondblClick=\"scoring2('3');\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src='/img/smile.png' id=\"smile3\" style='display:none'/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src='/img/nosmile.png' id=\"nosmile3\" style='display:none'/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"qna__ans__group__qna\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"qna__ans__group__pic qna__ans__group__pic__03\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img id=\"crop__img__03\" src=\"");
      out.print(rList.get(0).get(2).getCq_pic());
      out.write("\" style=\"display:none\"> <input type=\"hidden\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"qna__ans__group__num qna__ans__group__num__04\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<img class=\"colorShade\" src=\"/img/04.png\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tondblClick=\"scoring3('4');\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src='/img/smile.png' id=\"smile4\" style='display:none'/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src='/img/nosmile.png' id=\"nosmile4\" style='display:none'/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"qna__ans__group__qna\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"qna__ans__group__pic qna__ans__group__pic__04\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img id=\"crop__img__04\" src=\"");
      out.print(rList.get(0).get(3).getCq_pic());
      out.write("\" style=\"display:none\"> <input type=\"hidden\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"qna__ans__group__num qna__ans__group__num__05\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<img class=\"colorShade\" src=\"/img/05.png\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\tondblClick=\"scoring4('5');\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img src='/img/smile.png' id=\"smile5\" style='display:none'/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<img src='/img/nosmile.png' id=\"nosmile5\" style='display:none'/>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"qna__ans__group__qna\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"qna__ans__group__pic qna__ans__group__pic__05\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<img id=\"crop__img__05\" src=\"");
      out.print(rList.get(0).get(4).getCq_pic());
      out.write("s\" style=\"display:none\"> <input type=\"hidden\"\r\n");
