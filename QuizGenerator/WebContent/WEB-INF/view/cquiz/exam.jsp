...
<%@page import="poly.dto.CusQDTO"%>
<%
	List<List<CusQDTO>> rList = (List<List<CusQDTO>>) request.getAttribute("rList");
%>
			...
			<div id="qna">
				...
				<div class="qna qna__ques_o" id="qna__ques">
					<div class="qna__ques qna__ques__pic">
						<img id="editImg" src="<%=rList.get(0).get(0).getQ_pic()%>">
						<input type="hidden" id="editImgSrc" name="editImgSrc" />
					</div>
