...
public class OcrController {
	...
	final private String FILE_UPLOAD_SAVE_PATH = "e:/upload"; // C:\\upload 폴더에 저장
	...
	public String getReadforImageText(HttpServletRequest request, HttpServletResponse response, ModelMap model,
		...
		//if (ext.equals("jpeg") || ext.equals("jpg") || ext.equals("gif") || ext.equals("png")) {
			...
			String saveFileName = DateUtil.getDateTime("24hhmmss") + ".";
			...
			log.info("C- ext : " + pDTO.getExt());
			log.info("C- saveFileName : " + pDTO.getFileName());
			log.info("C- saveFilePath : " + pDTO.getFilePath());
			log.info("C- originalFileName : " + pDTO.getOrg_file_name());
